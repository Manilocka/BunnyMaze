...
{
    public class ConversationManager1 : MonoBehaviour
    {
        private enum eState
        {
        ...
        public static ConversationManager1 Instance { get; private set; }
        ...
        private void SelectPreviousOption()
        {
            ...
            {
                m_currentSelectedIndex = m_uiOptions.Count - 1; 
            }
        ...
        public void PressSelectedOption()
        {
            if (m_currentSelectedIndex < 0 || m_currentSelectedIndex >= m_uiOptions.Count) return;
